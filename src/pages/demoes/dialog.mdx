...
Unlike the [popover element](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/popover) which can only be opened as a non-modal, the dialog can be used as a modal or non-modal.
